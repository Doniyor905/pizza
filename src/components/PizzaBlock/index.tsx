...
type PizzaBlockProps = { id:string, title:string, sizes:number[], types:number[], price:number, count:number, imageUrl:string }
        ...
        <div className="pizza-block__selector">
          ...
          <ul>
            {sizes.map((size, i) => (
              <li
                key={size}
                onClick={() => setSizesActive(i)}
                className={sizesActive === i ? 'active' : ''}>
                {size} см.
              </li>
            ))}
          </ul>
